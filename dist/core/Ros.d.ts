...
import { default as Topic } from './Topic.js';
import { default as Param } from './Param.js';
import { default as Service } from './Service.js';
import { default as TFClient } from '../tf/TFClient.js';
import { default as ActionClient } from '../actionlib/ActionClient.js';
import { default as SimpleActionServer } from '../actionlib/SimpleActionServer.js';
/**
 ...
 */
export default class Ros extends EventEmitter<string | symbol, any> {
    /**
    ...
    constructor(options?: {
        ...
        transportLibrary?: "websocket" | RTCPeerConnection | undefined;
        transportOptions?: any;
    } | undefined);
    /** @type {WebSocket | import("ws").WebSocket | null} */
    socket: WebSocket | import('ws').WebSocket | null;
    idCounter: number;
    isConnected: boolean;
    ...
    TFClient(options: any): TFClient;
    ActionClient(options: any): ActionClient;
    SimpleActionServer(options: any): SimpleActionServer;
}
